...
class SpendCapService {
  static SpendCapProgress build({
    ...
    return SpendCapProgress(
      ...
      dailyExceeded: plan.dailyCapEnabled && todaySpent > plan.dailyCapAmount,
      weeklyExceeded: plan.weeklyCapEnabled && weekSpent > plan.weeklyCapAmount,
    );
  }
  ...
  static String dailyMessage({
    ...
    final remaining = (plan.dailyCapAmount - progress.todaySpent).clamp(0.0, double.infinity);
  ...
  static String weeklyMessage({
    ...
    final remaining = (plan.weeklyCapAmount - progress.weekSpent).clamp(0.0, double.infinity);
